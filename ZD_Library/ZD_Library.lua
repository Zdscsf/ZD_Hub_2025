...
local settingsTable = {
	General = {
		...
		ZDLibraryOpen = {Type = 'bind', Value = 'P', Name = 'ZDLibrary Keybind'},
		-- buildwarnings
		-- ZDLibraryprompts
...
local function loadSettings()
	...
	local success, result =	pcall(function()
		task.spawn(function()
			...
			if useStudio then
				file = [[
		{"General":{"ZDLibraryOpen":{"Value":"P","Type":"bind","Name":"ZDLibrary Keybind","Element":{"HoldToInteract":false,"Ext":true,"Name":"ZDLibrary Keybind","Set":null,"CallOnChange":true,"Callback":null,"CurrentKeybind":"P"}}},"System":{"usageAnalytics":{"Value":false,"Type":"toggle","Name":"Anonymised Analytics","Element":{"Ext":true,"Name":"Anonymised Analytics","Set":null,"CurrentValue":false,"Callback":null}}}}
	]]
			end
